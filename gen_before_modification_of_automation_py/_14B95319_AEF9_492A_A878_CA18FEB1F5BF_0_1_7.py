...
__all__ = [
    'DNC_SW_TYPE_UNKNOWN', 'DNC_E_STREAMING_ACTIVE',
    'DNC_DATAENTRY_PROPKIND_DATAWIDTH', 'DNC_TRACE_VARIABLE_ID_FEED',
    'DNC_DATA_UNIT_MILLIMETER_PER_MINUTE',
    'DNC_E_NO_TRACE_DATA_AVAILABLE', 'DNC_CP_PARITY',
    'DNC_PRG_STS_IDLE', 'DNC_ACCESS_MODE_IPODATAACCESS',
    '_IJHMachineEvents2Internal', 'DNC_SW_TYPE_MP_UIMS',
    'DNC_CP_HOST', 'DNC_DATA_UNIT_SELECT_INCH', 'DNC_EVT_PROGRAM',
    'DNC_INTERFACE_OBJECT', 'JHDataAccess', 'DNC_DATA_UNIT',
    'DNC_EC_NOTE', 'DNC_TRIG_SEQUENCE_NONE', 'DNC_E_FILE_WRONG_MODE',
    'DNC_SW_TYPE_TNC_DSP2', 'DNC32_E_PARITY',
    'IJHDataEntryProperty2List', 'JHCutterLocation', 'JHTest',
    'DNC_EC_INFO', 'DNC_POSSAMPLES_MOTION_TYPE',
    'DNC_DATA_UNIT_METER_PER_SEC4', 'DNC_POSSAMPLES_MOTION_LINEAR',
    'DNC_TRACE_VARIABLE_ID_INOM', 'DNC_ACCESS_MODE_PLCDEBUG',
    'DNC_SW_TYPE_TNC_DSPSG3', 'DNC_MODE', 'JHDataAccessEvents',
    'DNC_TRIG_ON_COND_GT', 'DNC_EVT_STATE_WAIT_PERMISSION',
    'DNC_PLC_ACTION_WRITE', 'DNC_E_UTC_TO_LOCAL', 'DNC_E_NOT_LOCKED',
    'IJHAxisInfoList', 'DNC_DATA_UNIT_METER_PER_SEC',
    'DNC32_E_NOT_RES', 'DNC_STATE_HOST_IS_NOT_AVAILABLE',
    'DNC_E_FILE_OPEN_FAILED', 'IJHAxesPositionStreaming2',
    'IJHErrorInternal', 'IJHTraceInternal', 'IJHTraceSample',
    'DNC_E_FILE_LOCKED', 'DNC_SW_TYPE_MP_ADMS', 'IJHCutterPosition',
    'IJHFileAttributes', 'DNC_ACCESS_MODE_SENDKEY',
    'DNC_AXISTYPE_AUX_ROTARY', 'DNC_E_RECORD_LOCKED',
    '_DJHAxesPositionStreamingEvents', '_DJHTraceEvents',
    'DNC_E_TOO_MANY_ELEMENTS', 'DNC_E_SYNONYM_ACCESS',
    'DNC_PROGRAMBREAKCONDITION_KIND_DEFAULT', '_IJHErrorEvents2',
    'DNC_EG_NONE', 'IJHDirectoryEntryList', 'JHError',
    'DNC_CP_LSV_DELAY', 'IJHConnection3', 'DNC_FILE_OBSERVE_REMOVE',
    'JHTraceSampleEnum', 'DNC_ERROR_GROUP', 'JHDataEntryEnum',
    'DNC_TRIG_ON_COND_OUTSIDE', 'DNC_SPINDLE_STATE_CCW',
    'JHAutomaticEvents', 'DNC_POSSAMPLES_MOTION_CIRCULAR',
    'DNC_ACCESS_MODE_OEM_ENCRYPTED', 'IJHCutterLocation',
    'IJHBreakCondition', 'DNC_TRACE_VARIABLE_ID_ANOM',
    'DNC_CP_SSH_REMOTE_HOST_KEY_FINGERPRINT', 'IJHError3',
    'DNC_DATA_UNIT_DEGREE_PER_SEC3', 'DNC_E_OUT_OF_RANGE',
    'DNC_ACCESS_MODE_ALL', 'DNC_E_INVALID_PASSWORD', 'DNC_EG_PYTHON',
    'DNC_EXEC_MDI', 'DNC_SW_TYPE_TNC_DSPSG1', 'IJHSoftwareVersion',
    'DNC_TRACE_VARIABLE_ID_CSI1', '_DJHAutomaticEvents',
    'DNC32_E_STILL_CONN', 'DNC_ERROR_LOCATION_OEM',
    'JHTraceSampleListList', 'DNC_DATA_UNIT_MILLIMETER_PER_SEC3',
    'DNC_ACCESS_MODE_AUTOMATIC', 'JHBreakCondition',
    'IJHDataAccessInternal', 'JHBreakConditionList',
    'IJHDataEntryList', 'DNC_E_DIR_OVERFLOW', 'DNC_CP_LSV_TX_TIMEOUT',
    'JHAxesPositionStreaming', 'DNC_PRG_EVT_STOPPED',
    'IJHSecureConnectionHelper2', 'DNC_TRIG_MODE',
    'IJHSoftwareVersionList', 'DNC_CNC_TYPE_MILLPLUS',
    'DNC_TRIG_ON_COND_LEQ', 'DNC_CNC_TYPE_MILLPLUSIT',
    'DNC_E_DIR_NOT_FOUND', 'DNC_TRACE_VARIABLE_TYPE_NORMAL',
    'DNC_TRIG_ON_COND_EQ', 'JHFileSystem',
    'DNC_POSSAMPLES_MOTION_SPLINE', 'DNC_EXEC_HANDWHEEL',
    '_IJHAutomaticEvents2', 'DNC_DATA_UNIT_DEGREE_PER_SEC',
    'DNC32_E_CONNECT_LOST', 'IJHDataEntry2', 'JHTraceVariableList',
    'IJHAutomatic', 'DNC_TRIG_SAMPLE_MODE', 'DNC_ACCESS_MODE_PLC',
    '_IJHMachineEvents2', 'DNC32_E_NO_PORT', 'IJHDataEntry',
    'JHSoftwareVersionEnum', 'DNC_POSSAMPLES_MOTION_COMPLEX',
    'IJHAxisPositionListList', 'DNC_DATA_UNIT_OTHER',
    'IJHSecureConnectionHelper', 'DNC_SPINDLE_STATE_TAPPING',
    'DNC_E_TRANSFER_ABORT', 'DNC_STATE_DNC_IS_STOPPED',
    'DNC_E_UNABLE_TO_DELETE', 'DNC_E_FILE_REMOTE_NOT_FOUND',
    'DNC_PLC_SIZE_BIT', 'DNC_EXEC_MODE', 'DNC_ACCESS_MODE_DSP',
    'DNC_STATE_HOST_IS_AVAILABLE', 'DNC_DATA_UNIT_DEGREE_PER_SEC2',
    'DNC_PRG_STS_NOT_SELECTED', 'JHDataEntryPropertyEnum',
    'DNC_E_ECLIPSED', 'IJHErrorEntryList', 'JHTriggerList',
    'JHDirectoryEntry', 'DNC_DATAENTRY_PROPKIND', 'IJHConnectionList',
    'IJHConnectionProperty', 'DNC_E_INVALID_DATA',
    'DNC_CP_DIO_PROTOCOL', 'DNC_TRIG_ON_FALL', 'DNC_E_FILE_EXISTS',
    'DNC_DATAENTRY_PROPKIND_LOWER_BOUND', '_IJHAutomaticEvents3',
    'IJHDiagnostics', 'IJHSecureConnectionHelper3',
    'DNC32_E_FAIL_ACCEPT', 'DNC_ACCESS_MODE_CFGDATAACCESS',
    '_IJHDataAccessEvents2', 'DNC32_E_OPTION_VAL',
    'JHDataEntryProperty', 'DNC_CNC_TYPE_TNC128_NCK',
    'JHTraceSampleList', 'DNC_PRG_EVT_SELECT_CLEARED',
    'IJHDataAccess4', 'DNC_ERROR_LOCATION', 'DNC_E_MULTIPLE_OBJECTS',
    'DNC_MODE_LOCAL', 'DNC_ACCESS_MODE_MONITOR',
    'DNC_CP_LSV_RX_TIMEOUT', 'IJHTraceSampleList', 'DNC_MODE_REMOTE',
    'JHDataEntryProperty2Enum', 'DNC_EVT_STATE_PERMISSION_DENIED',
    'IJHErrorEntry', 'JHDirectoryEntryEnum',
    'DNC_TRACE_VARIABLE_ID_IPODBG', 'DNC_POSSAMPLES_LOGGING_TYPE',
    'DNC_PROT_TCPIP', 'IJHRemoteErrorInternal',
    'DNC_AXISTYPE_SPINDLE', 'DNC_E_ALL_CONNECTIONS_IN_USE',
    'DNC_EVT_STATE_HOST_NOT_AVAILABLE', 'DNC_EVT_STATE_DNC_AVAILABLE',
    'DNC32_E_RECV_TIMEOUT', 'DNC_HRESULT', 'DNC32_E_INIT',
    'DNC_ERROR_CLASS', 'DNC_EC_WARNING', 'DNC_E_INVALID_CHANNEL',
    'DNC_E_TRACING_ACTIVE', 'IJHVersion',
    'DNC_TRACE_VARIABLE_ID_SDIFF', 'DNC_TRIG_SAMPLE_ON_PLC',
    'DNC_E_DIR_REMOTE_EXISTS', 'DNC_DATAENTRY_PROPKIND_DESCRIPTION',
    'DNC_SW_TYPE_TNC_OTHER', 'DNC_TRACE_VARIABLE_ID_JACT',
    'DNC_FILE_OBSERVE_REMOVE_ALL', 'DNC_ACCESS_MODE_NONE',
    '_DJHMachineEvents2', 'DNC_INTERFACE_JHDATAACCESS',
    '_DJHRemoteErrorEvents', 'DNC_SW_TYPE_CC',
    'DNC_SPINDLE_STATE_RIGID_TAPPING', 'DNC_CNC_TYPE', 'JHToolId',
    '_IJHTestEvents', 'JHTraceVariableEnum', 'DNC32_E_TRANS_FAIL',
    'JHFileAttributes', 'JHAxisPositionEnum', 'DNC_INTERFACE_JHTEST',
    'IJHCutterLocation2', 'DNC_E_NOT_INITIALISED',
    'JHCutterLocationEnum', 'DNC32_E_FAIL_WINSOCK',
    'DNC_TRACE_SOURCE_TYPE_UNKNOWN', 'DNC_TRACE_VARIABLE_ID_IPOLOGIC',
    'DNC_INTERFACE_JHREMOTEERROR', 'DNC_EC_NONE',
    'DNC_E_NO_STREAMING_ACTIVE', '_IJHFileSystemEvents',
    'DNC_EC_EMERGENCY_STOP', 'JHAxisPositionListList',
    'DNC_E_TIMEOUT', 'DNC_DATA_UNIT_SECOND',
    'DNC_ACCESS_MODE_DEFAULT', 'IJHTriggerCondition',
    'DNC_SW_TYPE_PLC', 'DNC_PRG_STS_ERROR',
    'DNC_INTERFACE_JHFILESYSTEM', 'DNC_TRIG_ON_COND_NONE',
    'IJHFileSystem', 'DNC_PROGRAMBREAKCONDITION_KIND',
    'DNC_TRACE_VARIABLE_TYPE', 'DNC_DATA_UNIT_METER_PER_SEC3',
    'DNC_FILE_OBSERVE_ADD', 'DNC_E_LOCAL_TO_UTC', 'JHConfiguration',
    'DNC_E_READ_ONLY', 'DNC_EXEC_SIMULO_TURBO_DEPRECATED',
    'DNC_CP_SSH_IDENT_PASSWORD', 'DNC_ACCESS_MODE_SCOPE',
    'DNC_TRACE_VARIABLE_ID_JNOM', 'DNC_INTERFACE_JHDIAGNOSTICS',
    'IJHTest', 'DNC_SW_TYPE_TNC_OPT', 'DNC_SW_TYPE_NCKERN',
    'JHProcessData', 'JHCutterLocation2Enum', 'IJHMachine',
    'DNC_PRG_EVT_COMPLETED', 'IJHAxisPosition', 'DNC_PLC_TYPE_MARKER',
    'DNC_PRG_STS_INTERRUPTED', 'DNC32_E_NOT_PROT',
    'DNC_DATA_UNIT_INCH', 'DNC_E_NOT_ADVISED', 'DNC_EG_PLC',
    'DNC_ACCESS_MODE_TESTUTILITY', '_IJHErrorEvents', 'JHDataEntry',
    'IJHCutterLocation2List', 'DNC_INTERFACE_JHPROCESSDATA',
    'DNC_ERROR_LOCATION_NONE', 'DNC_E_CANNOT_RESTORE_DEFAULT',
    'JHSoftwareVersionList', 'JHTraceVariable',
    'DNC_E_NO_PROGRAM_ACTIVE', '_IJHDiagnosticsEvents',
    'DNC_INTERFACE_JHTRACE', 'DNC_TRIG_INTERFACE_SAMPLING',
    'IJHErrorInternal2', 'DNC_ATTRIBUTE_MODIFIED',
    'DNC_E_PROGRAM_NOT_STARTED', 'DNC_PRG_STS_FINISHED',
    'IJHDataAccess3', 'DNC_E_NOT_POS_NOW',
    'DNC_ACCESS_MODE_GEOSIMDATAACCESS', 'IJHTraceSampleListList',
    'DNC_PRG_EVT_FINISHED', '_DJHDataAccessEvents', 'DNC_PROT_LSV2',
    'DNC_TRACE_VARIABLE_ID_SNOM', 'DNC_TRACE_VARIABLE_ID_VNACT',
    'DNC_E_CLIENT_REJECTED', 'DNC_CP_SSH_REMOTE_USER',
    'DNC_E_HOST_REJECTED', 'DNC_STATE_HOST_IS_STOPPED',
    'DNC_POSSAMPLES_LOGGING_ENDPOINTS', 'DNC_TRACE_VARIABLE_ID_PLC',
    'DNC_E_FILE_CANNOT_OPEN', 'DNC_SW_TYPE_FS_CCU',
    'JHTraceChannelList', 'DNC_E_WRONG_OPERATE_MODE',
    'DNC_CNC_TYPE_AR6000_NCK', 'DNC_E_IN_USE',
    'DNC_STATE_MACHINE_IS_AVAILABLE', 'DNC_DATA_UNIT_METER_PER_SEC2',
    '_IJHTraceEvents', 'JHSoftwareVersion',
    'DNC_TRACE_VARIABLE_ID_AACT', 'IJHDataAccess',
    'DNC_EXEC_SINGLESTEP', 'JHDataEntry2Enum', 'JHErrorEntry2List',
    'DNC_E_ENDSWITCH_TRIPPED', 'DNC32_E_NOT_CONN',
    'DNC_TRIG_SEQUENCE', 'DNC_SW_TYPE_TNC_DSPSG2', 'DNC_ACCESS_MODE',
    'DNC_EVT_STATE_HOST_AVAILABLE', 'DNC_E_RPCFAILED',
    'DNC_CONFIGURE_MODE_ADD', 'DNC_E_INVALID_PARAM',
    'DNC_ACCESS_MODE_TABLEDATAACCESS',
    'DNC_EVT_STATE_MACHINE_INITIALIZING', 'JHRemoteErrorEntry',
    'FEED_MODE_NORMAL', 'DNC_TRIG_ON_COND_GEQ', 'DNC_KEYACTION',
    'DNC_INTERFACE_TNCTABLE', 'DNC_PLC_OPTION',
    'DNC_TRIG_ON_CONDITION', 'DNC32_E_FAIL_LOOKUP',
    'DNC_E_HARD_DISK_FAIL', 'DNC_ATTRIBUTE_TYPE',
    'DNC_CONNECTION_PROPERTY', 'DNC_E_UNABLE_TO_SET',
    'DNC_TRACE_VARIABLE_ID_ININT', 'DNC_PLC_SIZE',
    'DNC_TRACE_VARIABLE_ID_CCDBG', 'DNC_E_UNABLE_TO_INSERT',
    'DNC_CP_SPEED', 'DNC_CNC_TYPE_ATEKM_NCK', 'DNC_EG_PROGRAMING',
    'DNC_SW_TYPE_TNC_ICTL3', 'JHMachineEvents2',
    'DNC_ACCESS_MODE_HWSDATAACCESS', 'DNC_PLC_SIZE_WORD',
    'IJHLoggingInternal', 'DNC_TRIG_SAMPLE_ON_TIMER',
    'JHTraceChannelEnum', 'DNC_EC_FEEDHOLD',
    'DNC_PRG_EVT_ERROR_CLEARED', 'DNC_PLC_OPTION_NOSYNC', 'JHTrigger',
    'DNC_TRIG_ON_RISE', 'DNC_CNC_TYPE_TNC7_NCK',
    'DNC_TRACE_VARIABLE_ID_ANALOG_OUT', 'DNC_DATAENTRY_PROPKIND_DATA',
    'DNC_CP_DATABITS',
    'DNC_POSSAMPLES_LOGGING_NONLINEAR_SAMPLED_WITH_BLOCK_END',
    'IJHTraceChannel', 'JHVersion', 'DNC_CNC_TYPE_MANUALPLUS_NCK',
    'DNC_E_LIST_EMPTY', 'DNC_ATTRIBUTE_SYSTEM',
    'DNC_INTERFACE_JHVIRTUALMACHINE', 'DNC_TRIG_SEQUENCE_AND',
    'DNC32_E_VER_TOO_OLD', 'JHTraceEvents', 'DNC_E_DIR_LOCKED',
    'DNC_TRIG_ON_COND_LT', 'DNC_TRIG_ON_COND_INSIDE', 'JHErrorEntry',
    'DNC_EXEC_AUTOMATIC', 'IJHError2', 'IJHAxisInfo',
    'DNC_SPINDLE_STATE_STOPPED', 'DNC_E_FILE_FILENAME',
    'DNC_PRG_STS_STOPPED', 'DNC_DATA_UNIT_NONE', 'DNC_E_WRONG_MODE',
    'DNC_CP_LSV_RETRIES', 'DNC_ATTRIBUTE_LOCKED',
    'IJHTriggerSampling', 'DNC_EC_PROGRAMABORT',
    'JHPositioningResult', 'DNC_E_CANNOT_START_PROGRAM',
    'DNC_DATAENTRY_PROPKIND_SAMPLE_CAPABILITY', 'DNC_HANDLE',
    'DNC_E_DIR_NOT_EMPTY', 'IJHChannelInfoList', 'IJHAutomatic4',
    'IJHConnection2', 'DNC_TRACE_VARIABLE_TYPE_UNKNOWN',
    'DNC_CNC_TYPE_ITNC', 'DNC_STATE_MACHINE_IS_BOOTED',
    'DNC_PRG_STS_RUNNING', 'DNC_TRACE_SOURCE_TYPE_IPO',
    'DNC32_E_NO_AUTODETECT', 'DNC_DATA_UNIT_PER_MINUTE',
    'DNC32_E_RECV_FAIL', 'DNC_E_FILE_LOCAL_OPEN_FAILED',
    'JHErrorEntryList', 'DNC_TRACE_VARIABLE_ID',
    'DNC_E_NO_TRACING_ACTIVE', 'DNC_DATA_UNIT_MILLIMETER_PER_SEC2',
    'DNC_E_DIR_NESTING', 'JHFileSystemEvents', 'JHAxisInfo',
    'DNC_E_FAIL', 'DNC_CNC_TYPE_TNC320_NCK', 'DNC32_E_RESERVED',
    'DNC_PLC_ACTION', 'DNC_ACCESS_MODE_AXESPOSITIONSTREAMING',
    'IJHDataAccess2', 'DNC_TRIG_ON_CHANGE',
    'JHDataEntryProperty2List', 'DNC_SW_TYPE_TNC_ICTL2', 'ITNCTable',
    'Library', 'JHDataEntryList', 'IJHDataEntryProperty2',
    'DNC_PRG_EVT_CANCELED', 'DNC_SPINDLE_STATE_CW',
    'DNC_POSSAMPLES_LOGGING_SAMPLED_WITH_BLOCK_END', 'DNC_PROT_DIO',
    'DNC_TRIG_MODE_NONE', 'DNC_E_LOCKED', '_IJHPlcEvents',
    'DNC_EG_REMOTE', 'JHCutterLocationList',
    'DNC_STATE_DNC_IS_AVAILABLE', 'DNC_TRACE_SOURCE_TYPE',
    'DNC_E_EXISTS', 'DNC_ATTRIBUTE_HIDDEN', 'JHPlc',
    'DNC_E_REMOTE_READ_ONLY', 'TNCTable', 'JHTestEvents',
    'DNC32_E_FAIL_CONNECT', 'DNC_SW_TYPE_TNC_ICTL1', 'DNC_CP_PORT',
    'JHMachineInProcess', '_DJHDiagnosticsEvents',
    'IJHTraceChannelList', 'DNC_CP_LSV_OPTIONS', 'IJHMachine4',
    'DNC_E_ITEM_DELETED', 'IJHErrorEntry2', 'DNC_EC_ERROR',
    'JHCutterLocation2List', 'DNC_DATA_UNIT_VOLT',
    'DNC_EVT_STATE_HOST_STOPPED', 'DNC32_E_FAIL_SOCKET',
    'DNC_DATA_UNIT_INCH_PER_MINUTE', 'JHAxisPosition',
    'JHChannelInfoList', 'DNC_FEED_MODE', 'IJHDataEntryProperty',
    'DNC_TRIG_CONDITION', 'DNC_PROT_RPC_SECURE',
    'DNC_POSSAMPLES_LOGGING_SAMPLED_WITH_BLOCK_END_WITH_AUX_AXES',
    'DNC_E_OPTION_NOT_AVAILABLE', 'DNC32_E_LISTEN_FAIL',
    'DNC_EVT_STATE_DNC_STOPPED', 'DNC_TRACE_VARIABLE_ID_SACT',
    'JHAxisInfoEnum', 'IJHTrigger', 'DNC_TRIG_SAMPLE_ON_CCU',
    'DNC32_E_VER_TOO_NEW', 'JHAxisPositionListEnum', 'IJHConnection',
    'DNC_E_CANNOT_LOAD_PROGRAM', 'DNC_SW_TYPE_TNC_DSP1',
    'DNC_DATAENTRY_PROPKIND_UPPER_BOUND', 'DNC_KEYACTION_UP',
    'DNC_CNC_TYPE_TNC6xx_NCK',
    'DNC_PROGRAMBREAKCONDITION_KIND_ON_LINE', 'DNC_ATTRIBUTE_DIR',
    'DNC_CNC_TYPE_MILLPLUSIT_NCK', 'JHDiagnosticsEvents',
    'DNC_TRIG_INTERFACE', 'DNC_PROTOCOL', 'DNC_E_NO_DRIVE_ACCESS',
    'DNC_E_SUBSCRIPTION_ACTIVE', 'DNC_PRG_EVT_ERROR',
    'DNC_CP_SSH_IDENT', 'FEED_MODE_RAPID', 'DNC_E_RECORD_NOT_FOUND',
    'IJHTraceVariableList', 'IJHTraceVariable',
    'DNC_DATAENTRY_PROPKIND_UNITTEXT',
    'DNC_EVT_STATE_MACHINE_AVAILABLE',
    'DNC_CNC_TYPE_GRINDPLUS640_NCK', 'DNC_E_DISK_FULL',
    'DNC_AXISTYPE_MAIN_LINEAR', 'JHDiagnostics',
    'DNC32_E_INVALID_PARAM', 'IJHAutomatic3', 'DNC_CP_LSV_AUTODETECT',
    'DNC_CNC_TYPE_ATEKM', 'DNC_INTERFACE_JHCONFIGURATION',
    'DNC_ACCESS_MODE_USR_PRIVATE',
    'DNC_EVT_STATE_MACHINE_SHUTTING_DOWN', '_DJHTestEvents',
    'IJHPositioningResult', 'DNC_CONFIGURE_MODE_CHANGE',
    'JHAxisInfoList', 'DNC_E_FILE_REMOTE_EXISTS',
    'DNC_EVT_STATE_CONNECTION_LOST', 'JHAxisPositionList',
    'DNC_ACCESS_MODE_OEM', 'JHProgramPositionEnum', 'DNC_EXEC_OTHER',
    'DNC_E_KEY_UNDEFINED', 'DNC_ATTRIBUTE_READONLY', 'DNC_EG_GENERAL',
    'DNC_E_DIR_REMOTE_NOT_FOUND', 'JHErrorEntry2Enum',
    'DNC_TRIG_SAMPLE_ON_IPO', 'JHErrorEvents', 'DNC32_E_FAIL_HANDLE',
    'DNC_INTERFACE_JHERROR', 'DNC_CP_STOPBITS', '_DJHPlcEvents',
    'DNC_DATAENTRY_PROPKIND_SUBSCRIBE_CAPABILITY', 'DNC_STS_PROGRAM',
    'DNC_DATA_UNIT_AMPERE', 'IJHVirtualMachine',
    'DNC_PROGRAMBREAKCONDITION_KIND_IGNORE_PROGRAMMED_STOP',
    'DNC_SW_TYPE_MC', 'DNC_INTERFACE_JHAXESPOSITIONSTREAMING',
    'IJHRemoteError', 'IJHAxesPositionStreaming', 'DNC_E_DIR_EXISTS',
    'IJHMachine2', '_DJHErrorEvents', 'DNC_SPINDLE_STATE_POS_CTRL',
    'DNC_E_FILE_REMOTE_FILENAME', 'IJHMachine3', 'IEventObject',
    'DNC_EXEC_RPF', 'DNC_FILE_OBSERVE', 'DNC_ACCESS_MODE_INSPECT',
    'DNC_DATA_UNIT_DEGREE', 'IJHBreakConditionList',
    'DNC_KEYACTION_DOWN', 'JHPlcEvents',
    'DNC_ACCESS_MODE_DIAGNOSTICS',
    'DNC_POSSAMPLES_LOGGING_NONLINEAR_SAMPLED_WITH_BLOCK_END_WITH_AUX_AXES',
    'JHBreakConditionEnum', 'DNC32_E_NO_ADDRESS', 'DNC_AXISTYPE',
    'JHCutterPosition', 'DNC_SW_TYPE_FS_MCU',
    'DNC_TRACE_VARIABLE_ID_SERR', 'JHMachineInProcessEvents2',
    'DNC_ACCESS_MODE_SYS', 'DNC_E_INVALID_AXIS',
    'IJHCutterLocationList', 'DNC_CNC_TYPE_TURNPLUS',
    'DNC_ACCESS_MODE_SPLCDATAACCESS', 'DNC_SW_TYPE_TNC_SG',
    'DNC_TRACE_VARIABLE_ID_VACT', 'DNC_INTERFACE_JHVERSION',
    'DNC_EVT_STATE_MACHINE_BOOTED', 'DNC_TRACE_VARIABLE_ID_NONE',
    'DNC_PLC_SIZE_BYTE', 'DNC_E_FILE_NOT_FOUND',
    'IJHProgramPositionList', '_IJHDataAccessEvents', 'IJHError',
    'DNC_STATE_NOT_INITIALIZED', 'DNC_STATE',
    'DNC_CNC_TYPE_GRINDPLUS_NCK', 'JHAutomatic', 'DNC_EC_PROGRAMHOLD',
    'JHVirtualMachine', 'DNC_INTERFACE_JHAUTOMATIC',
    'DNC_TRACE_VARIABLE_ID_VNNOM', 'DNC_TRACE_VARIABLE_TYPE_CHANNEL',
    'DNC_PLC_TYPE', 'DNC_E_COLLISION', 'DNC_E_FILE_OVERFLOW',
    'DNC_TRIG_ON_COND_NEQ', 'IJHDataEntry2List',
    'DNC_E_UNABLE_TO_GET', '_DJHFileSystemEvents', 'DNC_SW_TYPE',
    'IJHDataEntryPropertyList', 'DNC_SW_TYPE_FCL',
    'DNC_ACCESS_MODE_GEODATAACCESS', 'DNC_EC_RESET',
    'DNC_POSSAMPLES_LOGGING_ENDPOINTS_WITH_AUX_AXES',
    'IJHTriggerList', 'DNC_CP_DIO_LEADERLENGTH',
    'DNC_ERROR_LOCATION_EDIT', 'DNC_EXEC_MANUAL', 'DNC_PROT_COM',
    'IJHProcessData', 'DNC_PRG_EVT_STARTED', 'IJHTrace',
    'JHTraceSampleListEnum',
    'DNC_POSSAMPLES_LOGGING_SAMPLED_WITH_AUX_AXES',
    'DNC_PROGRAMBREAKCONDITION_KIND_FORCE_OPTIONAL_STOP',
    'DNC_CNC_TYPE_CNCPILOT6xx_NCK', 'DNC_DATA_UNIT_DEGREE_PER_SEC4',
    'DNC_DATA_UNIT_DEGREES_PER_MINUTE', 'DNC_EVT_STATE',
    'DNC_DATA_UNIT_METER', 'JHRemoteErrorEvents',
    'DNC_TRIG_ON_CHANGE_DELTA', 'JHErrorEntryEnum',
    'DNC_STATE_NO_PERMISSION', 'JHDataEntry2List', 'DNC_PROT_RPC',
    'IJHChannelInfo', 'DNC_TRACE_SOURCE_TYPE_CCU', 'DNC_E_NO_PROGRAM',
    'DNC_TRACE_VARIABLE_ID_VNOM', 'JHMachine', 'typelib_path',
    'DNC_SW_TYPE_SPLC', 'DNC_TRACE_VARIABLE_ID_CSI2',
    'DNC_TRIG_SAMPLE_ON_CHANGE', 'IJHRemoteErrorEntry',
    'DNC_DATA_UNIT_SELECT_METRIC', 'DNC_TRIG_INTERFACE_CONDITION',
    'DNC_E_DNC_PROHIBITED', 'DNC_E_FILE_REMOTE_LOCKED',
    'JHProgramPositionList', 'DNC_ACCESS_MODE_PLCDATAACCESS',
    'DNC_TRIG_SEQUENCE_AND_THEN', 'JHRemoteError',
    'DNC_CONFIGURE_MODE', 'DNC_E_ITEM_NOT_FOUND', 'IJHToolId',
    'DNC_ACCESS_MODE_USR', 'DNC_TRACE_VARIABLE_ID_BLOCK_NR',
    'DNC_KEYACTION_DOWN_UP', 'IJHRemoteErrorEntryInternal',
    'DNC_TRIG_SEQUENCE_OR', 'DNC_DATAENTRY_PROPKIND_INITIALVALUE',
    'DNC_TRIG_ALWAYS', 'DNC_STATE_MACHINE_IS_INITIALIZING',
    'DNC_DATAENTRY_PROPKIND_UNIT',
    'DNC_DATAENTRY_PROPKIND_BASE_ENTRY', 'JHProgramPosition',
    'DNC_TRIG_ON_SUSTAINED_CONDITION', 'DNC_ACCESS_MODE_DNC',
    'IJHPlc', 'IJHConfiguration', 'DNC_E_DIR_REMOTE_LOCKED',
    'IJHErrorEntry2List', 'IJHAxisPositionList',
    'DNC_DATA_UNIT_MILLIMETER', 'DNC_PRG_EVT_INTERRUPTED',
    'DNC_POSSAMPLES_LOGGING_SAMPLED', 'DNC_CONFIGURE_MODE_ALL',
    '_IJHAutomaticEvents', 'DNC_CONFIGURE_MODE_REMOVE',
    'JHChannelInfo', 'JHDirectoryEntryList', 'DNC_PRG_EVT_SELECTED',
    'DNC_E_MISSING_PARAM', 'JHTrace', 'DNC_INTERFACE_JHPLC',
    'DNC32_E_RECV_FRAME', 'JHTraceChannel', 'IJHAutomatic2',
    'DNC_CP_DIO_FLOWCTRL', '_IJHAxesPositionStreamingEvents',
    'JHTraceSample', 'JHDataEntryPropertyList',
    'DNC_TRACE_SOURCE_TYPE_PLC', 'JHChannelInfoEnum',
    'DNC_STATE_WAITING_PERMISSION', 'IJHProgramPosition',
    'IJHDirectoryEntry', 'DNC_E_FILE_IN_USE', 'DNC32_E_TIMEOUT_VAL',
    'DNC_SPINDLE_STATE', 'DNC_E_DNC32FAILED', 'DNC_SW_TYPE_TNC_DSP3',
    '_IJHRemoteErrorEvents', 'DNC_ERROR_LOCATION_MACHINE',
    'JHToolId0', 'DNC32_E_NOT_HANDLE', 'DNC_TRACE_VARIABLE_TYPE_PATH',
    'DNC_EG_OPERATING', 'DNC_DATAENTRY_PROPKIND_LOCATION',
    'DNC_STATE_MACHINE_IS_SHUTTING_DOWN', 'DNC_PROT_TCPIP_SECURE',
    'DNC_TRACE_VARIABLE_TYPE_AXIS', 'JHTriggerEnum',
    'JHAxesPositionStreamingEvents', 'DNC_AXISTYPE_AUX_LINEAR',
    'DNC_DATA_UNIT_SELECT', 'DNC_CP_CHECK_DTR',
    'DNC_SW_TYPE_TNC_MODEL', 'DNC_AXISTYPE_MAIN_ROTARY'
]
